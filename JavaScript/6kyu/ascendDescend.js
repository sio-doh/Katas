...
DESCRIPTION:
You are given three integer inputs: length, minimum, 
and maximum.
...
Notes:
    ...
    hyphens/dashes ("-") for negative numbers do count towards 
        the length
    the resulting string must be truncated to the exact length 
        provided
