...
// DESCRIPTION:
// It's a Pokemon battle! Your task is to calculate the 
// damage that a particular move would do using the following 
// formula (not the actual one from the game):
//     damage = 50 * (attack / defense) * effectiveness
// Where:
//     attack = your attack power
//     defense = the opponent's defense
//     effectiveness = the effectiveness of the attack based on 
//         the matchup (see explanation below)
// Effectiveness:
// Attacks can be super effective, neutral, or not very 
// effective depending on the matchup. For example, water would 
// be super effective against fire, but not very effective 
// against grass.
...
// are symmetric (if A is super effective against B, then B is 
// not very effective against A).
