...
Could it be from that girl/boy with a foreign accent 
...
Notes
    ...
    to keep this a beginner exercise you don't need to 
        check if the greeting is a subset of word (Hallowen 
        can pass the test)
