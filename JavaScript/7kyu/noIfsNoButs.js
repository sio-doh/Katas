...
// You cannot use if statements, and you cannot use the 
// ternary operator ? :.
// In fact the word if and the character ? are not allowed 
// in your code.

function noIfsNoButs(a, b) {
    return `${a}${[" is smaller than ", " is equal to ", 
                    " is greater than "][Math.sign(a - b) + 1]}${b}`;
}