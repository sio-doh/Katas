...
For example, 145 is strong, since 
1! + 4! + 5! = 1 + 24 + 120 = 145.
Task
...
Since, the sum of its digits' factorial (1) is equal to 
...
const strong = n => [...String(n)].reduce((a, b) => a +[...Array(Number(b))]
                                        .reduce((c, _, idx) => c * ++idx, 1), 0) 
                                        == n ? "STRONG!!!!" : "Not Strong !!"; 
