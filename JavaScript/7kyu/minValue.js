...
// could be formed from these digits, using the digits only 
// once (ignore duplicates).
// Notes:
//     Only positive integers will be passed to the function 
...
// Explanation:
// (579) is the minimum number could be formed from 
// {5, 7, 5, 9, 7} , Without duplications
