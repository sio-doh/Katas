...
// interest rate of p percent divided by 360 per day on the 1st 
// of January 2016. You want to have an amount a >= a0.
// Task:
// The function date_nb_days (or dateNbDays...) with parameters a0, 
// a, p will return, as a string, the date on which you have just 
// reached a.
// Example:
...
const dateNbDays = (a0, a, p) => 
    new Date(2016, 0, Math.ceil(Math.log(a / a0) / Math.log(p / 36000 + 1)) + 1)
        .toISOString()
        .slice(0,10);
