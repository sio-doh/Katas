...
# It happens that there are several possible (a, b). The 
# function returns an empty array (or an empty string) if 
...
# or
#     in C:
#     removNb(26) should return  {{15, 21}{21, 15}} tested 
#     by way of strings.
# Function removNb should return a pointer to an allocated 
# array of Pair pointers, each one also allocated. 
# Note
# See examples of returns for each language in 
# "RUN SAMPLE TESTS"
