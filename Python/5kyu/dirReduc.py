...
# another. The directions were "NORTH", "SOUTH", "WEST", 
# "EAST". Clearly "NORTH" and "SOUTH" are opposite, 
# "WEST" and "EAST" too. 
# Going to one direction and coming back the opposite 
# direction right away is a needless effort. Since this 
# is the wild west, with dreadful weather and not much 
# water, it's important to save yourself some energy, 
# otherwise you might die of thirst! 
# How I crossed a mountainous desert the smart way.
# The directions given to the man are, for example, the 
# following (depending on the language): 
...
# immediately "SOUTH" is not reasonable, better stay to the 
# same place! So the task is to give to the man a simplified 
# version of the plan. A better plan in this case is 
# simply: 
# ["WEST"]
# or
# { "WEST" }
...
# "NORTH" + "SOUTH" is going north and coming back right 
# away. 
...
# and "WEST" so the whole path is reducible to 
# ["WEST", "WEST"]. 
# Task
...
# "NORTH" and "WEST", "WEST" and "SOUTH", "SOUTH" and 
# "EAST" are not directly opposite of each other and 
# can't become such. Hence the result path is itself: 
