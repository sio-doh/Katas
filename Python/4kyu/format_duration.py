...
#       The unit of time is used in plural if the integer is 
#       greater than 1.
...
#       that the function should not return 61 seconds, but 1 
#       minute and 1 second instead. Formally, the duration 
