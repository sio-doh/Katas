...
# DESCRIPTION:
# Create a function close_compare that accepts 3 
# parameters: a, b, and an optional margin. The function 
# should return whether a is lower than, close to, or 
# higher than b.
# a is considered "close to" b if margin is greater than 
# or equal to the distance between a and b.
...
def close_compare(a, b, margin=0):
    if abs(a - b) <= margin or a == b: return 0
    elif a < b: return -1
    elif a > b: return 1
