...
# school holidays by re-painting the numbers on people's 
...
# But at the end of the day you realise not everybody did the same 
# amount of work.
# To avoid any fights you need to distribute the money fairly. That's 
# where this Kata comes in.
# Kata Task
...
#     etc...
# and so the method would 
# return [1,9,6,3,0,1,1,1,1,1]
# Notes
#     0 < start <= end
