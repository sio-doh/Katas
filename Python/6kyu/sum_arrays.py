...
# return [3,4,1]). Examples are given below of what two arrays 
# should return.
#     [3,2,9],[1,2] --> [3,4,1]
#     [4,7,3],[1,2,3] --> [5,9,6]
#     [1],[5,7,6] --> [5,7,7]
...
# number as the first index in the array. In this case treat the 
# whole number as a negative number. See below:
#     [3,2,6,6],[-7,2,2,8] --> [-3,9,6,2] # 3266 + (-7228) = -3962

def sum_arrays(array1, array2):
    if array1 == [] and array2 == []: return []
    elif array1 == []: array1 = [0]
    elif array2 == []: array2 = [0] 
    strng1 = "".join([str(x) for x in array1])
    strng2 = "".join([str(x) for x in array2])
    total = str(int(strng1) + int(strng2))
    new = []
    if total[0] == "-":
        new = [int(total[:2])]
        total = total[2:]
